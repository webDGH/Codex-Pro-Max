...
DMG="$DIST/CodexProMax-${VERSION}-macos-${ARCH}.dmg"
ICON_SOURCE="$ROOT/apps/codex-pro-max-manager/src-tauri/icons/icon.png"
ICON_NAME="codex-pro-max.icns"
...
prepare_icon() {
  local iconset="$DIST/codex-pro-max.iconset"
  rm -rf "$iconset"
  mkdir -p "$iconset"
