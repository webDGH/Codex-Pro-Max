use codex_pro_max_core::models::{DeleteStatus, SessionRef};
use codex_pro_max_data::{BackupStore, SQLiteStorageAdapter};
...
fn archived_lookup_workspace_move_and_sort_keys_match_expected_shape() {
    ...
    assert_eq!(
        adapter.find_archived_thread_by_title("Codex Thread"),
