use codex_pro_max_core::assets;
use codex_pro_max_core::bridge::{self, BRIDGE_BINDING_NAME};
use codex_pro_max_core::cdp::{CdpTarget, pick_page_target};
...
fn injection_script_marks_diagnostic_build_and_reports_script_loaded() {
    ...
    assert!(script.contains(codex_pro_max_core::assets::DIAGNOSTIC_BUILD_ID));
