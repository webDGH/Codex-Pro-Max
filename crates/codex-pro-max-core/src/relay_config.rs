...
const LEGACY_RELAY_PROVIDERS: &[&str] = &["CodexProMax", "CodexPP"];
const CHAT_UPSTREAM_BASE_URL_KEY: &str = "codex_pro_max_chat_base_url";
...
pub async fn test_relay_profile(
    ...
    let client = crate::http_client::proxied_client("CodexProMax/RelayTest")?;
