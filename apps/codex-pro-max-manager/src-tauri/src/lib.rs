...
pub fn run() {
    ...
    let run_result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::launch_codex_pro_max,
            commands::restart_codex_pro_max,
...
fn acquire_single_instance_guard() -> Option<std::net::TcpListener> {
    match codex_pro_max_core::ports::acquire_loopback_port_guard(
        codex_pro_max_core::ports::MANAGER_GUARD_PORT,
    ) {
        ...
        Err(error) if error.kind() == std::io::ErrorKind::AddrInUse => {
            let _ = codex_pro_max_core::diagnostic_log::append_diagnostic_log(
                ...
                serde_json::json!({
                    "guard_port": codex_pro_max_core::ports::MANAGER_GUARD_PORT
                }),
            );
            None
        }
