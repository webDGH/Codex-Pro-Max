...
export function App() {
  ...
  const launch = async () => {
    const result = await launchCommand("launch_codex_pro_max");
    if (result) {
  ...
  const launchCommand = async (command: "launch_codex_pro_max" | "restart_codex_pro_max") => {
        ...
        <CardContent>
          <div className="recommend-hero">
            <div>
              ...
              <span>内容来自 shgkz/Ad-List，分为赞助商推荐和普通推荐。</span>
            </div>
      ...
      <Panel>
        ...
        <CardContent>
          <div className="metric-list">
            ...
            <Metric label="项目地址" value="github.com/shgkz/codex-pro-max" />
          </div>
          <Toolbar>
            <Button onClick={() => void actions.openExternalUrl("https://github.com/shgkz/codex-pro-max")} variant="secondary">
              <ExternalLink className="h-4 w-4" />
              打开项目主页
            </Button>
            <Button onClick={() => void actions.openExternalUrl("https://github.com/shgkz/codex-pro-max/issues")} variant="secondary">
              <ExternalLink className="h-4 w-4" />
              反馈问题
            </Button>
...
function ContextScreen({
  ...
  return (
    <Panel fill>
      <CardHead title="Codex 工具与插件" detail="独立管理 Codex 的 MCP、Skills、插件；切换任意供应商都会带上。" />
      <CardContent>
        <RelayContextManager
    ...
    <div className="relay-context-panel">
      <div className="relay-context-head">
        <div>
          ...
          <span>MCP、Skills、插件 作为全局配置独立管理，切换任意供应商都会合并。</span>
        </div>
      ...
      <div className="relay-file-panel">
        <div className="relay-file-head">
          <div>
            ...
            <span>只保留非 MCP、Skills、插件 的跨供应商配置；工具与插件在独立页面管理。</span>
          </div>
          <Button
            onClick={async () => {
