...
<p align="center">
  <img src="docs/images/codex-pro-max.png" alt="codex-pro-max 图标" width="160">
</p>
...
<table>
  ...
  <tr>
    ...
    <td><a href="https://jojocode.com/"><strong>JOJO Code｜codex-pro-max 官方中转站</strong></a><br>感谢 JOJO Code 赞助了本项目！JOJO Code 是 codex-pro-max 官方中转站，面向日常开发和团队协作场景，提供稳定可用的 Codex API 接入体验，适合快速接入、长期使用和项目级工作流。</td>
  </tr>
  <tr>
    <td align="center">
    ...
    <td><a href="https://aigocode.com/invite/CodexProMax"><strong>AIGoCode</strong></a><br>感谢 AIGoCode 赞助了本项目！AIGoCode 是一个集成了 Claude Code、Codex 以及 Gemini 最新模型的一站式平台，为你提供稳定、高效且高性价比的AI编程服务。本站提供灵活的订阅计划，支持多风险，国内直连，无需魔法，极速响应。AIGoCode 为 CodexProMax 的用户提供了特别福利，通过<a href="https://aigocode.com/invite/CodexProMax">此链接注册</a>的用户首次充值可以获得额外10%奖励额度！</td>
  </tr>
  <tr>
    <td align="center">
    ...
    <td><a href="https://www.packyapi.com/"><strong>PackyCode</strong></a><br>感谢 PackyCode 赞助了本项目！PackyCode 是一家稳定、高效的API中转服务商，提供 Claude Code、Codex、Gemini 等多种中转服务。PackyCode 为本软件的用户提供了特别优惠，使用此链接注册并在充值时填写"CodexProMax"优惠码，首次充值可以享受9折优惠！</td>
  </tr>
  <tr>
    <td align="center">
...
欢迎扫码加入 codex-pro-max 交流群（QQ群：1103050832），反馈问题、交流使用体验或提出新功能建议：

<img src="docs/images/discussion-group-qr.jpg" alt="codex-pro-max 交流群二维码" width="260">

如果 codex-pro-max 帮到了你，可以请我喝杯咖啡，或者随手赞赏支持一下继续维护。
...
codex-pro-max 启动后会解锁插件入口，并在会话列表悬停时显示删除按钮：

![codex-pro-max 解锁插件入口并添加删除按钮](docs/images/solution-plugin-and-delete.png)

顶部菜单栏会出现 `codex-pro-max`，可以查看后端状态并打开设置面板：

![codex-pro-max 后端状态指示灯](docs/images/backend-status-indicator.png)
![codex-pro-max 设置面板](docs/images/settings-panel.png)
